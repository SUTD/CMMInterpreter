...
/* File: globals.h                                  */
/* Bison Version                                    */
/* Global types and vars for CMM Interpreter        */
...
typedef enum {IfK, WhileK, AssignK, ReadK, DeclK, CompoundK, WriteK} StmtKind;
typedef enum {OpK, IntValueK, RealValueK, IdK} ExpKind;
typedef enum {Int=1, Real, Bool} ExpType;
